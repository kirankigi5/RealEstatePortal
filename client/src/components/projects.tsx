  ...
  return (
    <section id="projects" className="py-20 bg-gray-100 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-4 text-gray-800 dark:text-white" data-aos="fade-up">
              ...
              <div className="p-6">
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button 
                      className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white py-4 rounded-xl font-bold hover:scale-105 transition-all duration-300 border-0 premium-shadow flex items-center justify-center space-x-2"
